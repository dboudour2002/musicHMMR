...
#define p7_ETARGET_MUSIC  0.59 /* bits,  from the work of Steve Johnson. */
 ...
 */
#define p7_MAXABET    30      /* maximum size of alphabet (4 or 20)              */
#define p7_MAXCODE    39      /* maximum degenerate alphabet size (18 or 29)     */
...
/* Other stuff.
 */
#define p7_MAXDCHLET  25      /* maximum # Dirichlet components in mixture prior */
