...
static ESL_OPTIONS options[] = {
  ...
  { "--music",       eslARG_NONE,     FALSE,     NULL, NULL, ALPHOPTS,  NULL,  NULL, "assert <seqfile>, <hmmfile> both music intervals: no autodetection",      2 },
...
main(int argc, char **argv)
{
  ...
  else if (esl_opt_GetBoolean(go, "--music"))   abc = esl_alphabet_Create(eslMUSIC);
